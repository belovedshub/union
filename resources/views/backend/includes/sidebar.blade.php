    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @if ($logged_in_user->isAdmin())
                ...
                <li class="nav-item">
                    <a class="nav-link {{ active_class(Active::checkUriPattern('admin/union-full*')) }}" href="{{route('admin.union-full')}}">
                    @lang('menus.backend.union-full.main')
                    </a>
                </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/union-poll*')) }}" href="{{ route('admin.union-poll') }}">
                @lang('menus.backend.union-poll.main')
                </a>
            </li>
        </ul>
    </nav>
